...
COND_DIR = os.path.normpath(os.path.join(_base, cfg["paths"]["cond_dir"]))
CHECKPOINT_DIR = os.path.normpath(os.path.join(_base, cfg["paths"]["checkpoint_dir"]))
SAMPLES_DIR = os.path.normpath(os.path.join(_base, cfg["paths"]["samples_dir"]))
